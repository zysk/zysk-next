      ...
      <section className="container py-20 mx-auto px-6 xl:px-0">
        <div className="flex flex-row justify-between items-center flex-col sm:flex-row">
          ...
          <div className="basis-1/2">
            ...
            <p className="mt-4 highlight">
              A web development services company based in Bangalore, India. At
              Zysk, we understand that web and mobile applications are the
              backbones of e-businesses, which is why we put in a lot of effort
              and think outside the box to deliver solutions that help
              businesses flourish.
            </p>
            <p className="mt-4 highlight">
              Our team at Zysk is focused on understanding your requirements
              thoroughly to deliver web and mobile solutions that are accurate
              and cost-effective. We aim to convert new opportunities into
              success stories by providing web solutions that are simple, quick
              and scalable.
            </p>
            <div className="mt-10">
      ...
      <section className="container py-10 mx-auto px-6 xl:px-0">
        ...
        <div className="flex flex-wrap justify-between flex-col sm:flex-row">
          <div className="service-thumb text-dark basis-1/3 py-4">
            ...
            <p className="py-3">
              In the era of ubiquitous computing, a Business portfolio optimized
              for devices of all sizes is a must! With the use of frameworks
              like Gatsby...
            </p>
          ...
          <div className="service-thumb text-dark basis-1/3 py-4">
            ...
            <p className="py-3">
              ...
              idea to life? With our expertise of developing applications from
              scratch, you...
            </p>
          ...
          <div className="service-thumb text-dark basis-1/3 py-4">
            ...
            <p className="py-3">
              ...
              Back-end APIs will get best User Interfaces without comprimising
              the user...
            </p>
          ...
          <div className="service-thumb text-dark basis-1/3 py-4">
            ...
            <p className="py-3">
              A satisfactory User Experience needs an application without bugs.
              Use our QA Services and automation testing expertise to save
          ...
          <div className="service-thumb text-dark basis-1/3 py-4">
            ...
            <p className="py-3">
              {`Don't`} want the hassle of managing two versions (Android and
              iOS) of the same app? Hybrid Apps are the way to go! Increase
              engagement by reaching your customers on multiple...
            </p>
          ...
          <div className="service-thumb text-dark basis-1/3 py-4">
            ...
            <p className="py-3">
              A successful online business requires a website that is fresh and
              up-to-date and protected from hacks and attacks. Our commitment to
              reaching stablity and perfection in our code...
            </p>
            <a className="link" href="#">
              Read more
            </a>
